...
describe Permissions do
  describe "as guest" do
    ...
    it "allows students" do
      should_not allow_action("students", "index")
      should allow_action("students", "show")
      should_not allow_action("students", "new")
      should_not allow_action("students", "create") 
      should_not allow_action("students", "edit")
      should_not allow_action("students", "update") 
      should_not allow_action("students", "destroy")
    end
  end
  
  describe "as student" do
    subject { Permissions.permission_for(FactoryGirl.build(:student)) }
    ...
    it "allows users/registrations" do
      should_not allow_action("users/registrations", "new")
      should_not allow_action("users/registrations", "create")
  ...
  describe "as staff" do
    ...
    it "allows students" do
      should allow_action("students", "index")
      should allow_action("students", "show")
      should_not allow_action("students", "new")
      should_not allow_action("students", "create") 
      should_not allow_action("students", "edit")
  ...
  describe "as teacher" do
    subject { Permissions.permission_for(FactoryGirl.build(:teacher)) }
    ...
    it "allows enrollments" do
      ...
      should_not allow_action("enrollments", "edit")
      should_not allow_action("enrollments", "update") 
      should_not allow_action("enrollments", "reverse") 
      should_not allow_action("enrollments", "destroy")
    end
    ...
    it "allows teachers" do
      should_not allow_action("teachers", "index")
      should allow_action("teachers", "show")
      should_not allow_action("teachers", "new")
      should_not allow_action("teachers", "create") 
      should_not allow_action("teachers", "edit")
