...
(function() {
  var fetchCourseDetails, showCourses;

  jQuery(function() {
    $('.datepicker').fdatepicker(function() {});
    ({
      format: 'mm-dd-yyyy'
    });
    ...
    $('#enrollment_discipline_id').change(function() {
      return showCourses();
    });
    $('#enrollment_course_id').change(function() {
      return fetchCourseDetails();
    });
    return $("a.submit").click(function() {
      return $(this).closest('form').submit();
    });
  });

  showCourses = function() {
    var batch_options, batches, course_options, courses, discipline;
    ...
    if (course_options && batch_options) {
      ...
      return $('#discipline_config_error').show();
    }
  };
  ...
  fetchCourseDetails = function() {
    ...
    return $.ajax("/courses/" + course_id, {
      ...
      success: function(result) {
        ...
        return $('#enrollment_duration').val(result.duration);
      },
      error: function(result) {
        return alert("Error fetching Course Details");
      }
    });
  };
